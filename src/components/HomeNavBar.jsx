...
export default function HomeNavBar() {
    return (
        ...
        <div className="hidden lg:flex lg:flex-row lg:items-center lg:justify-end bg-white lg:space-x-5 lg:text-lg lg:text-white lg:h-[10vh] lg:w-full lg:mr-10 lg:ml-auto">
                        ...
                        {/* <NavLink to="/" className={({isActive}) => isActive ? "hover:bg-sky-900 bg-sky-700 font-medium h-full p-1 hover:rounded-lg" : "hover:bg-sky-400 font-medium p-1 rounded-lg"}>Home</NavLink> */}
