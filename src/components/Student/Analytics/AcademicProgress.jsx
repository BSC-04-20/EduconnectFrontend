...
const AcademicProgress = ({ loadingStats, statsError, assignmentStats, getAssignmentCompletionRate, getProgressColor, studentData }) => (
  <div className="bg-white rounded-lg shadow-md p-6 mb-8">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-2">
            ...
            {getAssignmentCompletionRate() !== null && (
              <ProgressBar 
                ...
                color={getProgressColor(getAssignmentCompletionRate())}
              />
            )}
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
            <span>Submitted by Due Date</span>
            <span className="font-semibold">{studentData.onTimeSubmissionRate}%</span>
          </div>
          <ProgressBar 
            percentage={studentData.onTimeSubmissionRate} 
            color={getProgressColor(studentData.onTimeSubmissionRate)}
          />
          <p className="text-sm text-gray-600">
            {studentData.onTimeSubmissionRate >= 80 ? 'Great time management!' : 
              studentData.onTimeSubmissionRate >= 60 ? 'Consider setting earlier personal deadlines' : 
