...
export default function StudentsAssignments() {
    return (
        <div className="bg-white p-6 rounded-lg mt-5 w-[95%]">
            <h2 className="text-xl font-bold text-sky-900 mb-4">Assignments</h2>
            <div className="grid grid-cols-3 gap-4 mb-4 pr-24">
...
function StatCard({ icon, label, count, color }) {
    return (
        <div className="flex flex-row gap-3 items-center border-2 p-4 rounded-lg">
