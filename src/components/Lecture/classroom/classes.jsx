...
export default function LectureClasses(){
    return( 
        <div className="grid grid-cols-3 gap-5 px-5 ">
            <div className="bg-white place-content-start  h-[35vh] w-[50%] rounded-lg ">
            ...
            <div className="bg-white place-content-start items-right h-[35vh] w-[50%] rounded-lg ">
                <div className=" text-white  bg-sky-900 gap-2 px-5 py-2 h-[30%] w-[100%] rounded-lg ">
            ...
            <div className="bg-white  place-content-start place-items-left  h-[35vh] w-[50%] rounded-lg  ">
                <div className=" text-white  bg-sky-900 py-2 gap-2 px-5 h-[30%] w-[100%] rounded-lg  ">
